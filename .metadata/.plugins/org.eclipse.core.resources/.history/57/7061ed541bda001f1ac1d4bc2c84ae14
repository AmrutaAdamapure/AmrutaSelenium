...
public class SocialMediaTracker
{
    ...
    try 
   {
    while (true) 
    {
    	...
    	System.out.println("1.SignUp Instagram \n2.Login Instagram \n3.Search Id \n4.Chat with an Id \n5.Scroll Reels");
    ...
    switch (option) 
    {
		...
		case 2: 
		{
			...
			SocialMediaTracker.login(username, password,usernameField,passwordField);
			break;
		}
		...
		case 4:
		{
			System.out.println("Enter the id you want to chat with:");
            Thread.sleep(10000);
        	String userId =sc.next();
            chat(userId);
    ...
    public static void login(String username,String password,WebElement usernameField,WebElement passwordField) 
	{
		try
		{
    ...
    public static void watchReels() throws InterruptedException 
    {
    	...
    	{
			Thread.sleep(3000);
			driver.findElement(By.xpath("/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[1]/div[2]/div/div/div/div/div[2]/div[4]/span/div/a/div/div[2]/div/div/span/span")).click();
		}
        ...
        driver.manage().window().minimize();
        System.out.println("Reels were played");
	}
    
    public static void chat(String userId) throws InterruptedException 
    {
    	driver.get("https://www.instagram.com/" + userId + "/");
        Thread.sleep(7000);
