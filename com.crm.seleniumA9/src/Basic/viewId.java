...
public class viewId {
    ...
    public void viewIdDetails(WebDriver driver) throws InterruptedException {
        try 
        {
            ...
            System.out.println("Followers are: " + totalF);
        ...
        catch (Exception e) 
        {
            ...
            File destinationFile = new File("D:\\Private\\screenshot.png");
            ...
            System.out.println("It's a private account, so you can get its screenshot in D drive and private named folder");
        }
    }
}